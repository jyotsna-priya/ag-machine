              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold">New Machine Request</span>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
             ...
             <div class="card-body">
              <div class="table-responsive">
                 ...
                 <input type="submit" class="d-none d-sm-inline-block btn btn-md btn-success shadow-md text-white" name="action" value="Remove">
                  <input type="submit" class="d-none d-sm-inline-block btn btn-md btn-success shadow-md text-white" name="action" value="Assign">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body" id="map">
                  <img class="mx-auto d-block" src="img/farms.png"/>
                  <img class="mx-auto d-block" src="img/farm.jpg"/>
                </div>
              </div>
           </div>
  <div>
