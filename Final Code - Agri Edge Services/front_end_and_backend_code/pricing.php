    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Simple Drone</h5>
            <h6 class="card-price text-center">$2<span class="period">/day</span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Base Price-$50.00</li>
      ...
      <div class="col-lg-3">
        <div class="card mb-6 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Deluxe Drone</h5>
            <h6 class="card-price text-center">$4<span class="period">/day</span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Base Price - $100.00</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>5 Sensors</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Tracking</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Backup Cloud Storage</li>
              <li><span class="fa-li"><i class="fas fa-times"></i></span>Dedicated Support </li>
      ...
      <div class="col-lg-3">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Simple Tractor</h5>
            <h6 class="card-price text-center">$6<span class="period">/day</span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Base Price - $200.00</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>5 Sensors</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Tracking</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Backup Cloud Storage</li>
              <li><span class="fa-li"><i class="fas fa-times"></i></span>Dedicated Support </li>
      ...
      <div class="col-lg-3">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Deluxe Tractor</h5>
            <h6 class="card-price text-center">$8<span class="period">/day</span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Base Price - $400.00</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>5 Sensors</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Tracking</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Backup Cloud Storage</li>
              <li><span class="fa-li"><i class="fas fa-times"></i></span>Dedicated Support </li>
